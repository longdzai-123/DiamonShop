			...
			<div class="well well-small">
				<ul class="nav nav-list">
				   <c:forEach var="item" items="${categorys}">
				   		<li><a href='<c:url value="/san-pham/${item.id}"/>' style="font-size: 17px">
						     <i class="icon-chevron-right" ></i>${item.name}</a>
					    </li>
				   </c:forEach>
						      ...
						      <div class="item active">
							      <ul class="thumbnails">
							         <c:forEach var="item" items="${ products }" varStatus="loop">
							              <li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="<c:url value ="/chi-tiet-san-pham/${item.id_product}" />"><span class="icon-search"></span>
													Xem Sản Phẩm</a> <a href="#" class="tag"></a> <a
							...
							<li class="span4">
								<div class="thumbnail">
									<a class="zoomTool" href="chi-tiet-san-pham/${item.id_product }"
										title="add to cart"><span class="icon-search"></span> Xem Sản Phẩm</a> <a href="chi-tiet-san-pham/${item.id_product }"><img
